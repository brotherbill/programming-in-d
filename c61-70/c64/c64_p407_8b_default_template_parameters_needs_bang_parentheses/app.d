...
void main()
{
    ...
    // auto ageExplicitInt = getResponse!int("What is your age?");
    // writeln("Your explicitInt age is: ", ageExplicitInt);
    // writeln;

    // auto ageImplicitInt = getResponse("What is your age?");
    // writeln("Your implicitInt age is: ", ageImplicitInt);
    // writeln;

    // auto ageExplicitDouble = getResponse!double("What is your age?");
    // writeln("Your explicitDouble age is: ", ageExplicitDouble);
}

void intPointDistance()
{
    Point!() center; // Point!(int)(0, 0)  default type: int
